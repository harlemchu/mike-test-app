...
class FacultyDepartmentManager extends StatefulWidget {
  ...
  @override
  State<FacultyDepartmentManager> createState() =>
      _FacultyDepartmentManagerState();
}

class _FacultyDepartmentManagerState extends State<FacultyDepartmentManager> {
  var _nameController = TextEditingController();
  var _descriptionController = TextEditingController();
  var _imageController;
  final _departmentManagerformKey = GlobalKey<FormState>();
  File? _image;
  ...
  Future<void> _updateFacultyData(String logo, String description) async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      for (var doc in querySnapshot.docs) {
        CollectionReference users =
            FirebaseFirestore.instance.collection('FacultyDepartments');
  ...
  Future<void> _saveFaculty() async {
    if (_departmentManagerformKey.currentState!.validate()) {
      try {
        String? imageUrl;
        if (_image == null) {
        ...
        _updateFacultyData(imageUrl, _descriptionController.text);
